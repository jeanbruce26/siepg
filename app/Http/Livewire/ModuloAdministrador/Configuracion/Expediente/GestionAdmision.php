...
class GestionAdmision extends Component
{
    ...
    {
        $this->dispatchBrowserEvent('alerta-expediente-admision', [
            'title' => $title,
            'text' => $text,
            'icon' => $icon,
            'confirmButtonText' => $confirmButtonText,
    ...
    public function cargarAlertaEstado($id_expediente_admision)
    {
        ...
        $this->alertaConfirmacion('¿Estás seguro?',"¿Desea cambiar el estado del admisión $expedienteAdmision->admision del expediente $expedi->expediente?",'question','Modificar','Cancelar','primary','danger','cambiarEstado',$id_expediente_admision);
    }
    ...
    public function cambiarEstado(ExpedienteAdmision $expedienteAdmision)
    {
        ...
        $this->alertaExpediente('¡Éxito!', "El estado del admisión $admi->admision del expediente $expedienteAdmision->id_expediente ha sido actualizado satisfactoriamente.", 'success', 'Aceptar', 'success');
    }
    ...
    public function render()
    {
        ...
        $expedienteAdmisionModel = ExpedienteAdmision::join('admision','admision.id_admision','=','expediente_admision.id_admision')
                                        ...
                                        })->orderBy('expediente_admision.id_expediente_admision','desc')->get();
