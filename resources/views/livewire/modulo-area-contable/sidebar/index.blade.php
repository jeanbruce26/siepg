        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link {{ $route === 'contable.inicio' ? 'active' : '' }}"
                        href="{{ route('contable.inicio') }}">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $route === 'contable.pago' ? 'active' : '' }}"
                        href="{{ route('contable.pago') }}">
                        <span class="menu-icon">
                            <i class="ki-outline ki-office-bag fs-1"></i>
                        </span>
                        <span class="menu-title fs-4">Pagos</span>
                        @if ($pago > 0)
                            <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-15px position-relative"
