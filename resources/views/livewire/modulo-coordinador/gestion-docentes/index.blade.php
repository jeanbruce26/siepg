                            ...
                            <div class="table-responsive">
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-center mb-5 w-100">
                                    <div class="col-md-4 pe-md-3 mb-2 mb-md-0">
                                        <button type="button" class="btn btn-light-primary fw-bold w-100px w-md-125px" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="filtros_docentes" wire:ignore.self>
                                            <div class="px-7 py-5">
                                            ...
                                            <form class="px-7 py-5" wire:submit.prevent="aplicar_filtro">
                                                <div class="mb-5">
                                                    ...
                                                    <div>
                                                        <select class="form-select" wire:model="filtro_grado_academico" id="filtro_grado_academico"  data-control="select2" data-placeholder="Seleccione su grado académico">
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <div>
                                                        <select class="form-select" wire:model="filtro_tipo_docente" id="filtro_tipo_docente"  data-control="select2" data-placeholder="Seleccione el tipo de docente">
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div>
                                                            @if ($item->trabajador_perfil_url)
                                                                <img src="{{ asset($item->trabajador_perfil_url) }}" alt="foto de perfil" class="w-40px h-40px rounded object-cover">
                                                            @else
                                                                <img src="{{ asset('assets/media/avatars/blank.png') }}" alt="foto de perfil" class="w-40px h-40px rounded">
                                                            @endif
                                                        </div>
                                                        <span>
                                                            {{ $item->trabajador_apellido }}, {{ $item->trabajador_nombre }}
                                                        </span>
                                                    </div>
                                                </td>
                                                <td class="fs-6">
                                                ...
                                                <td class="fs-6">
                                                    @if ($item->docente_estado == 1)
                                                        <span class="badge badge-primary fs-6 px-3 py-2" wire:click="alerta_cambiar_estado({{ $item->id_docente }})" style="cursor: pointer;">
                                                            Activo
                                                        </span>
                                                    @else
                                                        <span class="badge badge-danger fs-6 px-3 py-2" wire:click="alerta_cambiar_estado({{ $item->id_docente }})" style="cursor: pointer;">
                                                            Inactivo
                                                        </span>
                                                    @endif
                                                </td>
                                                <td class="text-center">
                                                    <button type="button"
                                                        class="btn btn-light btn-flex btn-center fw-bold btn-active-light-primary btn-outline btn-outline-dashed hover-scale"
                                                        data-kt-menu-trigger="click"
                                                        data-kt-menu-placement="bottom-end"
                                                        data-kt-menu-flip="top-end">
                                                        Acciones
                                                        <span class="svg-icon fs-5 ms-2 me-0 m-0">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="#modal_docente" wire:click="cargar_docente({{ $item->id_docente }}, 'edit')" class="menu-link px-3 fs-6" data-bs-toggle="modal"
                                                                data-bs-target="#modal_docente">
                                                                Editar Datos
                                                            </a>
                                                        </div>
