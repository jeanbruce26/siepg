        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="#modalPlan" wire:click="modo()" class="btn btn-primary btn-sm hover-elevate-up" data-bs-toggle="modal" data-bs-target="#modalPlan">Nuevo</a>
                </div>
            </div>
        </div>
            ...
            <div id="kt_app_content_container" class="app-container container-fluid pt-5">
                <div class="card shadow-sm">
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            @if ($item->plan_estado == 1)
                                                <span style="cursor: pointer;" wire:click="cargarAlerta({{ $item->id_plan }})" class="badge text-bg-success text-light hover-elevate-down fs-6 px-3 py-2">Activo</span>
                                            @else
                                                <span style="cursor: pointer;" wire:click="cargarAlerta({{ $item->id_plan }})" class="badge text-bg-danger text-light hover-elevate-down fs-6 px-3 py-2">Inactivo</span>
                                            @endif
                                        </td>
                                        <td align="center">
                        ...
                        @if ($plan_model->hasPages())
                            <div class="d-flex justify-content-between mt-5">
                                <div class="d-flex align-items-center text-gray-700">
                                    Mostrando {{ $plan_model->firstItem() }} - {{ $plan_model->lastItem() }} de
                                    {{ $plan_model->total() }} registros
                                </div>
                                <div>
                                    {{ $plan_model->links() }}
                                </div>
