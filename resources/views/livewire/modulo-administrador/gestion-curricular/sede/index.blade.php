        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="#modalUsuario" wire:click="modo()" class="btn btn-primary btn-sm hover-elevate-up" data-bs-toggle="modal" data-bs-target="#modalSede">Nuevo</a>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            @else
                                                <span style="cursor: pointer;" wire:click="cargarAlertaEstado({{ $item->id_sede }})" class="badge text-bg-danger text-light hover-elevate-down">Inactivo <span class="pulse-ring"></span></span>
                                            @endif
                                        </td>
                                        <td align="center">
