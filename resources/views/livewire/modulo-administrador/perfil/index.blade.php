                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center mb-5">
                                    <a class="text-gray-900 fw-bold me-4" style="font-size: 2.3rem">
                                        {{ ucwords(strtolower($trabajador->trabajador_nombre)) }}
                                        {{ ucwords(strtolower($trabajador->trabajador_apellido)) }}
                                    </a>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <form autocomplete="off">
                                <div class="mb-5 row align-items-center">
                                    <div class="col-4">
                                        <label for="apellido"
                                            class="@if ($modo == 'edit') required @endif form-label">Apellido</label>
                                    </div>
                                    <div class="col-8">
                                        <input type="text" wire:model="apellido"
                                            class="form-control fw-bold @error('apellido') is-invalid @enderror @if ($modo == 'show') form-control-transparent @endif"
                                ...
                                <div class="mb-5 row align-items-center">
                                    <div class="col-4">
                                        <label for="nombre"
                                            class="@if ($modo == 'edit') required @endif form-label">Nombre</label>
                                    </div>
                                    <div class="col-8">
                                        <input type="text" wire:model="nombre"
                                            class="form-control fw-bold @error('nombre') is-invalid @enderror @if ($modo == 'show') form-control-transparent @endif"
                                ...
                                <div class="mb-5 row align-items-center">
                                    <div class="col-4">
                                        <label for="documento_identidad"
                                            class="@if ($modo == 'edit') required @endif form-label">Documento
                                            de Identidad</label>
                                    </div>
                                    <div class="col-8">
                                        <input type="text" wire:model="documento_identidad"
                                            class="form-control fw-bold @error('documento_identidad') is-invalid @enderror @if ($modo == 'show') form-control-transparent @endif"
                                            id="documento_identidad" placeholder="Ingrese su documento identidad"
                                            @if ($modo == 'show') readonly @endif />
                                    </div>
                                </div>
                                <div class="mb-5 row align-items-center">
                                    <div class="col-4">
                                        <label for="correo_electronico"
                                            class="@if ($modo == 'edit') required @endif form-label">Correo
                                            Electronico</label>
                                    </div>
                                    <div class="col-8">
                                        <input type="email" wire:model="correo_electronico"
                                            class="form-control fw-bold @error('correo_electronico') is-invalid @enderror @if ($modo == 'show') form-control-transparent @endif"
                                            id="correo_electronico" placeholder="Ingrese su correo electronico"
                                            @if ($modo == 'show') readonly @endif />
                                    </div>
                                </div>
                                <div class="mb-5 row align-items-center">
                                    <div class="col-4">
                                        <label for="direccion"
                                            class="@if ($modo == 'edit') required @endif form-label">Direccion</label>
                                    </div>
                                    <div class="col-8">
                                        <input type="text" wire:model="direccion"
                                            class="form-control fw-bold @error('direccion') is-invalid @enderror @if ($modo == 'show') form-control-transparent @endif"
                                ...
                                <div class="mb-5 row align-items-center">
                                    <div class="col-4">
                                        <label for="grado_academico"
                                            class="@if ($modo == 'edit') required @endif form-label">Grado
                                            Academico</label>
                                    </div>
                                    <div class="col-8">
                                        @if ($modo == 'show')
                                            <input type="text" wire:model="grado_academico_input"
                                                class="form-control fw-bold @if ($modo == 'show') form-control-transparent @endif"
                                                id="grado_academico_input" placeholder="Ingrese su grado academico"
                                                readonly />
                                        @elseif ($modo == 'edit')
                                            <select wire:model="grado_academico"
                                                class="form-select @error('grado_academico') is-invalid @enderror"
                                                id="grado_academico" data-control="select2"
                                                data-placeholder="Seleccione su grado academico">
                                                <option></option>
                                ...
                                @if ($modo == 'edit')
                                    <div class="mb-5 row align-items-center">
                                        ...
                                        <div class="col-8">
                                            <input type="file" wire:model="perfil"
                                                class="form-control fw-bold @error('perfil') is-invalid @enderror"
                                                id="upload({{ $iteration }})" accept="image/*" />
                                        </div>
                                    </div>
                                    @if ($perfil)
                                        <div class="mb-5 row align-items-center">
                                            <div class="col-4"></div>
                                            <div class="col-8">
                                                <img src="{{ $perfil->temporaryUrl() }}" class="img-thumbnail"
                        ...
                        @if ($modo == 'edit')
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" wire:click="guardar_perfil" class="btn btn-primary"
                                    wire:loading.attr="disabled" wire:loading.remove
                                    wire:target="guardar_perfil, perfil">
                                    Guardar
                                </button>
                                <button type="button" wire:click="guardar_perfil" class="btn btn-primary"
                                    wire:loading.attr="disabled" wire:loading wire:target="guardar_perfil">
                                    <span class="spinner-border spinner-border-sm align-middle me-2"></span>
                                    Guardando...
                                </button>
                                <button type="button" wire:click="guardar_perfil" class="btn btn-primary"
                                    wire:loading.attr="disabled" wire:loading wire:target="perfil">
                                    <span class="spinner-border spinner-border-sm align-middle me-2"></span>
                                    Cargando...
                                </button>
                            </div>
                        ...
                        <div>
                            <form autocomplete="off">
                                <div class="mb-5 row align-items-center">
                                    ...
                                    <div class="col-8">
                                        <input type="text" wire:model="usuario_nombre"
                                            class="form-control fw-bold form-control-transparent" id="usuario_nombre"
                                            readonly />
                                    </div>
                                </div>
                                <div class="mb-5 row align-items-center">
                                    ...
                                    <div class="col-8">
                                        <input type="email" wire:model="usuario_correo"
                                            class="form-control fw-bold form-control-transparent" id="usuario_correo"
                                            readonly />
                                    </div>
                                </div>
                            </form>
