            ...
            <div class="card-body">
                <div class="row g-5">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="mb-5">
                            <img src="{{ asset($voucher->temporaryUrl()) }}" height="200px" alt="voucher" />
                        </div>
                        <a href="{{ asset($voucher->temporaryUrl()) }}" target="_blank" class="btn btn-sm btn-dark">
                            Ver Voucher
                        </a>
                    </div>
                    @endif
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <select wire:model="modalidad" class="form-select @error('modalidad') is-invalid @enderror"
                                id="modalidad">
                    ...
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <select wire:model="programa" class="form-select @error('programa') is-invalid @enderror"
                                id="programa" data-control="select2" data-placeholder="Seleccione su programa"
                                data-allow-clear="true">
                                <option></option>
                                @if ($modalidad)
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select wire:model="estado_civil"
                                class="form-select @error('estado_civil') is-invalid @enderror" id="estado_civil">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="email" wire:model="email_opcional"
                                class="form-control @error('email_opcional') is-invalid @enderror" id="email_opcional"
                    ...
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <input type="text" wire:model="pais_direccion"
                                class="form-control @error('pais_direccion') is-invalid @enderror" id="pais_direccion"
                                placeholder="Ingrese el pais del ubigeo seleccionado">
                    ...
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <input type="text" wire:model="pais_nacimiento"
                                class="form-control @error('pais_nacimiento') is-invalid @enderror" id="pais_nacimiento"
                                placeholder="Ingrese su pais de nacimiento">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select wire:model="grado_academico"
                                class="form-select @error('grado_academico') is-invalid @enderror" id="grado_academico">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" wire:model="centro_trabajo"
                                class="form-control @error('centro_trabajo') is-invalid @enderror" id="centro_trabajo"
                        ...
                        <tbody>
                            ...
                            <tr wire:key="{{ $item->id_expediente_admision }}">
                                <td>
                                    ...
                                    <span class="text-danger" style="font-size: 0.9rem">(Obligatorio)</span>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <input type="file" wire:model="expedientes.{{ $item->id_expediente_admision }}"
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" @if
                        ($check_formas_pago==false) disabled @endif>
                        Cerrar
                    </button>
                </div>
            </div>
