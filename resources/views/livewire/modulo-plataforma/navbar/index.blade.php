<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
    ...
    <div class="app-navbar flex-shrink-0">
        <div class="app-navbar-item ms-2 ms-md-4">
            <button class="btn btn-secondary btn-sm fs-5 position-relative fw-bold me-5" data-kt-drawer-show="true" id="modulo_notioficaciones_button">
                Notificaciones
                @livewire('modulo-plataforma.notificaciones.contador')
            </button>
        </div>
        <div class="app-navbar-item ms-2 ms-md-4" id="kt_header_user_menu_toggle">
            <div class="text-end d-none d-sm-flex flex-column justify-content-center me-3">
                ...
                <a href="{{ route('plataforma.perfil') }}" class="text-gray-800 fs-4 fw-bold d-block">
                    {{ ucwords(strtolower($persona->primeros_nombres)) }}
                </a>
            </div>
            <div class="cursor-pointer symbol symbol-35px symbol-md-45px"
                data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                data-kt-menu-placement="bottom-end">
                    <img src="{{ $usuario->usuario_estudiante_perfil_url ? asset($usuario->usuario_estudiante_perfil_url) : $usuario->avatar }}" class="object-fit-cover" alt="avatar" />
            </div>
