                                        ...
                                        @if ($expedientes)
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true" style="">
                                                                <div class="menu-item px-3">
                                                                    <a href="#modal_expediente" wire:click="cargar_expediente_inscripcion({{ $item->cod_ex_insc }})" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#modal_expediente">
                                                                        Editar
                                                                    </a>
                                                                </div>
                                                            </div>
                                            ...
                                            @if ($valor == 0)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-light-danger">No Entregado</span>
                                                    </td>
                                                    <td>
                                                        Sin fecha
                                                    </td>
                                                    @if ($inscripcion->admision_cod_admi == $admision->cod_admi)
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true" style="">
                                                                <div class="menu-item px-3">
                                                                    <a href="#modal_expediente" wire:click="cargar_expediente({{ $item2->cod_exp }})" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#modal_expediente">
                                                                        Agregar
                                                                    </a>
                                                                </div>
                                                            </div>
