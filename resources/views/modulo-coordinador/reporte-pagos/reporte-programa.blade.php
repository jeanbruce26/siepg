...
@section('title', 'Reporte de Pagos de Programas - Direccitor de Unidad - Escuela de Posgrado')
@section('content')
@livewire('modulo-coordinador.reporte-pagos.reporte-programa' , ['id_programa_proceso' => $id_programa_proceso])
@endsection
@section('scripts')
    <script>
