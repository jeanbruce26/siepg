...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true"
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <div id="kt_app_header" class="app-header">
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    ...
                    @livewire('modulo-plataforma.navbar.index')
                </div>
            </div>
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                <!--begin::Sidebar-->
                @livewire('modulo-plataforma.sidebar.index')
                <!--begin::Main-->
    ...
    <div id="modulo_notioficaciones" class="bg-white" data-kt-drawer="true" data-kt-drawer-activate="true"
        data-kt-drawer-overlay="true" data-kt-drawer-toggle="#modulo_notioficaciones_button"
