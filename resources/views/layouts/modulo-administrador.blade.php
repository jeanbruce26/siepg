                    ...
                    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
								...
								{{-- Configuración --}}
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->is('administrador/programa') || request()->is('administrador/plan')  || request()->is('administrador/sede') || request()->is('administrador/expediente') || request()->is('administrador/tipo-seguimiento') ? 'active show border-2 border-start border-gray-300 rounded' : ''}}">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-muted svg-icon-2 {{ request()->is('administrador/programa') || request()->is('administrador/plan') || request()->is('administrador/sede') || request()->is('administrador/expediente') || request()->is('administrador/tipo-seguimiento') ? 'text-primary' : ''}}">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ request()->is('administrador/tipo-seguimiento') ? 'active border-3 border-start border-primary' : '' }}" href="{{ route('administrador.tipo-seguimiento') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
