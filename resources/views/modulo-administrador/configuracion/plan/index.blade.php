...
@livewire('modulo-administrador.configuracion.plan.index')
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.configuracion.plan.index', event.detail.metodo, event.detail.id);
            }
        })
    })
</script>
