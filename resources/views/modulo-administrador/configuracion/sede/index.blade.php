...
@livewire('modulo-administrador.configuracion.sede.index')
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.configuracion.sede.index', event.detail.metodo, event.detail.id);
            }
        })
    })
