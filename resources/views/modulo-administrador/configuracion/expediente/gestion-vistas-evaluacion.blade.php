...
@livewire('modulo-administrador.configuracion.expediente.gestion-vistas-evaluacion', ['id_expediente' => $id_expediente])
...
<script>
	...
	window.addEventListener('alerta-expediente-gestion-vistas-evaluacion', event => {
        Swal.fire({
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.configuracion.expediente.gestion-vistas-evaluacion', event.detail.metodo, event.detail.id);
            }
        })
    })
</script>
