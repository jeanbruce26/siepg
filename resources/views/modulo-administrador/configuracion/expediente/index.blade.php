...
@livewire('modulo-administrador.configuracion.expediente.index')
...
<script>
	...
	window.addEventListener('alerta-expediente', event => {
        Swal.fire({
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.configuracion.expediente.index', event.detail.metodo, event.detail.id);
            }
        })
    })
</script>
