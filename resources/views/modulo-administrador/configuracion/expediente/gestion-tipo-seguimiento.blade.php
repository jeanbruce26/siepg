...
@livewire('modulo-administrador.configuracion.expediente.gestion-tipo-seguimiento', ['id_expediente' => $id_expediente])
...
<script>
	...
	window.addEventListener('alerta-expediente-gestion-tipo-seguimiento', event => {
        Swal.fire({
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.configuracion.expediente.gestion-tipo-seguimiento', event.detail.metodo, event.detail.id);
            }
        })
    })
</script>
