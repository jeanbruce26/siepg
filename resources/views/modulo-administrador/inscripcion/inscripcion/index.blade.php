...
@livewire('modulo-administrador.inscripcion.inscripcion.index')
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.inscripcion.inscripcion.index', event.detail.metodo, event.detail.id);
            }
        })
    })
