...
@livewire('modulo-administrador.inscripcion.inscripcion-pago.index')
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.inscripcion.inscripcion-pago.index', event.detail.metodo, event.detail.id);
            }
        })
    })
