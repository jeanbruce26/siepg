...
@livewire('modulo-administrador.gestion-admision.inscripcion-pago.index')
...
<script>
	...
	window.addEventListener('alerta-inscripcion-pago', event => {
        Swal.fire({
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.gestion-admision.inscripcion-pago.index', event.detail.metodo, event.detail.id);
            }
        })
    })
