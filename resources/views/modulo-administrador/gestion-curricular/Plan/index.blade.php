...
@livewire('modulo-administrador.gestion-curricular.plan.index')
...
<script>
	...
	window.addEventListener('alerta-plan', event => {
        Swal.fire({
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.gestion-curricular.plan.index', event.detail.metodo, event.detail.id);
            }
        })
    })
</script>
