...
@livewire('modulo-administrador.gestion-pagos.concepto-pago.index')
...
<script>
	...
	window.addEventListener('alerta-concepto-pago', event => {
        Swal.fire({
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.gestion-pagos.concepto-pago.index', event.detail.metodo, event.detail.id);
            }
        })
    })
