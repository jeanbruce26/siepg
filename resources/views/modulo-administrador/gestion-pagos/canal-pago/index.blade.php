...
@livewire('modulo-administrador.gestion-pagos.canal-pago.index')
    ...
    window.addEventListener('alertaConfirmacion', event => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.gestion-pagos.canal-pago.index', event.detail.metodo, event.detail.id);
            }
        })
    })
